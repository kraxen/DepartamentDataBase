...
namespace DepartamentDataBase
{
    public class Worker
    {
        ...
        #region Сортировка
        public class SortWorkersByName : IComparer<Worker>
        {
        ...
        public class SortWorkersBySalary : IComparer<Worker>
        {
            public int Compare(Worker x, Worker y)
            {
        ...
        public class SortWorkersByAge : IComparer<Worker>
        {
            public int Compare(Worker x, Worker y)
            {
        ...
        public class SortWorkersByDoljnost : IComparer<Worker>
        {
            public int Compare(Worker x, Worker y)
            {
                return String.Compare(x.Doljnost, y.Doljnost);
            }
        }
        #endregion
    }
